...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        DarkCore::CreatureLastSearcher<DarkCore::NearestAssistCreatureInCreatureRangeCheck> searcher(this, pCreature, u_check);
...
void Creature::CallForHelp(float fRadius)
{
    ...
    DarkCore::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), fRadius);
